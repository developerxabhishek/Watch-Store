...
const AdminUpdateProduct = () => {
  ...
  const products = useSelector((state) => state.updateProductSlice.value);
...
const loader=()=>{
  // setImage(products.images[0])
    ...
    setOrigin(products.origin);
    setShippingArea(products.shippingarea);
    setShippingFees(products.shippingfees);
...
useEffect(()=>{
  ...
  const handleSubmit = () => {
    ...
    const url = `https://watch-store-p4zm.onrender.com/updateProducts/${products._id}`;
    axios
      .post(url, formData)
      .then((result) => {
        console.log(result);
